...
if __name__ == '__main__':
    ...
    for i in range(0, 10):
        ...
        noise = isp.RGB2BGR(noise)
        gt = isp.RGB2BGR(gt)
        cv2.imwrite('../figs/00045_inverse'+str(i)+'.png', noise * 255)
        cv2.imwrite('../figs/00045_gt' + str(i) + '.png', gt * 255)
